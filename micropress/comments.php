...
<section id="mp-comments">
    ...
    <?php if ( post_password_required() ) : ?>
        <p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'microPress' ); ?></p>
        </div><!-- #comments -->
        <?php
    ...
    if (have_comments() && comments_open()) :
        ...
        echo '<h2 class="mp-comments-heading"><small>';
        if ($ncomments == 1)
    ...
    <?php if ($ncomments > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
